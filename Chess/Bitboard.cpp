...
bool Attacks::IsAnyPieceAttacking(int Square, PieceColor Color, PieceType Type, uint64_t AttackingPiecesBitboard, const uint64_t AllOccupiedBitboard, const uint64_t FriendlyPiecesBitboard) const
{
	uint64_t (Attacks::*GetMovesFunc)(int, const uint64_t, const uint64_t) const =
